...
const Resources = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className=" leading-tight text-[10rem] whitespace-normal text-white font-bold  w-full h-50 bg-cover bg-center text-center bg-[url('')] rounded-lg p-20 containerBackground">
          <span className="uppercase"> Are you looking for resources?</span>
        </h1>
      </div>
      ...
      <div className="absolute bottom-10 flex  m-10">
        <a href="#">
          <button className="uppercase flex gap-7 px-10 py-6 bg-zinc-900 rounded-full items-center text-white text-center  hover:bg-gray-800">
            Resources
